...
function App() {
    ...
    return (
            ...
            <InputColumn personalData={personalData} educationData={educationData} workExperienceData={workExperienceData} handlePersonalDataChange={handlePersonalDataChange} handleSectionChange={handleSectionChange} addSection={addSection} />
    ...
    function handleSectionChange(e: React.ChangeEvent<HTMLInputElement>) {
        ...
        if(type === 'education') {
            ...
            const newWorkExperienceData = structuredClone(workExperienceData[key]);
    ...
    function addSection(type: string) {
        if(type === 'education') {
            setEducationData({
                ...educationData,
                [crypto.randomUUID()]: {'degree': '', 'school': '', 'location': '', 'start': '', 'end': '', 'subject': '', 'description': ''}
            });
        } else if(type === 'work-experience') {
            setWorkExperienceData({
                ...workExperienceData,
                [crypto.randomUUID()]: {'company': '', 'position': '', 'location': '', 'start': '', 'end': '', 'description': ''}
            });
        }
    }
}
...
export default App;
export { PersonalData, EducationData, EducationDataSection, WorkExperienceData, WorkExperienceDataSection };
