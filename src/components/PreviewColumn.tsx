...
import { EducationDataSection, PersonalData, WorkExperienceDataSection } from "../App";
...
function PreviewColumn({ personalData, educationData, workExperienceData }: PreviewColumnProps) {
    return (
