...
import { PersonalData, EducationDataSection, WorkExperienceDataSection } from '../App';
...
function InputColumn(props: InputColumnProps) {
    const { personalData, educationData, workExperienceData, handlePersonalDataChange, handleSectionChange, addSection } = props;

    return (
        <div className="column input-column">
            <PersonalSection personal={personalData} onChange={handlePersonalDataChange} />
            <EducationSection educations={educationData} onChange={handleSectionChange} addSection={addSection} />
            <WorkSection experiences={workExperienceData} onChange={handleSectionChange} addSection={addSection}/>
        </div>
